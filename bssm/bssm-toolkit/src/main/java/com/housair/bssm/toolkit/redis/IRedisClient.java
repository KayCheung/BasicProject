...
public interface IRedisClient {
     ...
     * @param value 值 
     * @param expireTime seconds, -1表示无时间限制
     * @return Bulk reply
     */
    public String set(final String key,final String namespace, final String value,final int expireTime);
     ...
     *            exist.
     * @param expx EX|PX, expireTime time units: EX = seconds; PX = milliseconds
     * @param expireTime expireTime time in the units of {@param #expx}
     * @return Status code reply
     */
    public String set(final String key,final String namespace, final String value, final String nxxx, final String expx, final long expireTime);
     ...
     * @return Bulk reply
     */
    public String get(final String key,final String namespace) ;
     ...
     */
    public Boolean exists(final String key,final String namespace) ;    
     ...
     */
    public String type(final String key,final String namespace) ;
     ...
     */
    public Long expire(final String key,final String namespace, final int seconds) ;
     ...
     *         the timeout), or the key does not exist.
     */
    public Long expireAt(final String key,final String namespace, final long unixTime) ;
     ...
     */
    public Long ttl(final String key,final String namespace) ;
    ...
    public Boolean setbit(final String key,final String namespace, final long offset, final boolean value) ;
    ...
    public Boolean getbit(final String key,final String namespace, final long offset) ;
    ...
    public Long setrange(final String key,final String namespace, final long offset, final String value) ;
    ...
    public String getrange(final String key,final String namespace, final long startOffset, final long endOffset) ;
    ...
    public String getSet(final String key,final String namespace, final String value) ;
    ...
    public Long setnx(final String key,final String namespace, final String value) ;
    /**
     * Get the value of the specified key. If the key does not exist the special value 'nil' is returned. If the value
     * stored at key is not a string an error is returned because GET can only handle string values.
     * <p>
    ...
    public <T> String setex(final String key,final String namespace, final int seconds, final T value) ;
    ...
    public String setex(final String key,final String namespace, final int seconds, final String value) ;    
    ...
    public Long decrBy(final String key,final String namespace, final long integer) ;
    ...
    public Long decr(final String key,final String namespace) ;
    ...
    public Long incrBy(final String key,final String namespace, final long integer) ;
    ...
    public Long incr(final String key,final String namespace) ;
    ...
    public String substr(final String key,final String namespace, final int start, final int end) ;
    ...
    public Long hset(final String key,final String namespace, final String field, final String value) ;
    ...
    public String hget(final String key,final String namespace, final String field) ;
    ...
    public Long hsetnx(final String key,final String namespace, final String field, final String value) ;
    ...
    public String hmset(final String key,final String namespace, final Map<String, String> hash) ;
    ...
    public List<String> hmget(final String key,final String namespace, final String... fields) ;
    ...
    public Long hincrBy(final String key,final String namespace, final String field, final long value) ;
    ...
    public Boolean hexists(final String key,final String namespace, final String field) ;
    ...
    public Long hdel(final String key,final String namespace, final String... field) ;
    ...
    public Long hlen(final String key,final String namespace) ;
    ...
    public Set<String> hkeys(final String key,final String namespace) ;
    ...
    public List<String> hvals(final String key,final String namespace) ;
    ...
    public <T> List<T> hvalsObject(final String key,final String namespace,Class<T> type ) ;   
    ...
    public Map<String, String> hgetAll(final String key,final String namespace) ;
    ...
    public Long llen(final String key,final String namespace) ;
    ...
    public List<String> lrange(final String key,final String namespace, final long start, final long end) ;
    ...
    public String ltrim(final String key,final String namespace, final long start, final long end) ;
    ...
    public String lindex(final String key,final String namespace, final long index) ;
    /**
     * 设置指定索引值
     * 
     * @param key specified key
    ...
    public String lset(final String key,final String namespace, final long index, final String value) ;
    ...
    public Long lrem(final String key,final String namespace, final long count, final String value) ;
    ...
    public String lpop(final String key,final String namespace) ;
    ...
    public String rpop(final String key,final String namespace) ;
    /**
    ...
    public Long sadd(final String key,final String namespace, final String... member) ;
    ...
    public Set<String> smembers(final String key,final String namespace) ;
    ...
    public Long srem(final String key,final String namespace, final String... member) ;
    ...
    public String spop(final String key,final String namespace) ;
    ...
    public Long scard(final String key,final String namespace) ;
    ...
    public Boolean sismember(final String key,final String namespace, final String member) ;
    ...
    public String srandmember(final String key,final String namespace) ;
     ...
     * @return Bulk reply
     */    
	public List<String> srandmember(String key, String namespace, int count);
    ...
    public Long zadd(final String key,final String namespace, final double score, final String member) ;
    ...
    public Set<String> zrange(final String key,final String namespace, final long start, final long end) ;
    ...
    public Long zrem(final String key,final String namespace, final String... member) ;
    ...
    public Double zincrby(final String key,final String namespace, final double score, final String member) ;
    /**
    ...
    public Long zrank(final String key,final String namespace, final String member) ;
    ...
    public Long zrevrank(final String key,final String namespace, final String member) ;
    /**
     * zrevrange
     * 
     * @param key specified key
    ...
    public Set<String> zrevrange(final String key,final String namespace, final long start, final long end) ;
    ...
    public Set<Tuple> zrangeWithScores(final String key,final String namespace, final long start, final long end) ;
    /**
     * zrevrangeWithScores
     * 
     * @param key specified key
    ...
    public Set<Tuple> zrevrangeWithScores(final String key,final String namespace, final long start, final long end) ;
    ...
    public Long zcard(final String key,final String namespace) ;
    ...
    public Double zscore(final String key,final String namespace, final String member) ;
    ...
    public List<String> sort(final String key,final String namespace) ;
    ...
    public List<String> sort(final String key,final String namespace, final SortingParams sortingParameters) ;
    /**
     * zcount
     * 
     * @param key specified key
    ...
    public Long zcount(final String key,final String namespace, final double min, final double max) ;
    /**
    ...
    public Set<String> zrangeByScore(final String key,final String namespace, final double min, final double max) ;
    ...
    public Set<String> zrevrangeByScore(final String key,final String namespace, final double max, final double min) ;
    ...
    public Set<String> zrangeByScore(final String key,final String namespace, final double min, final double max, final int offset,
            final int count) ;
    ...
    public Set<String> zrevrangeByScore(final String key,final String namespace, final double max, final double min, final int offset,
            final int count) ;
    ...
    public Long zremrangeByRank(final String key,final String namespace, final long start, final long end) ;
    ...
    public Long zremrangeByScore(final String key,final String namespace, final double start, final double end) ;
    ...
    public Set<Tuple> zrangeByScoreWithScores(final String key,final String namespace, final double min, final double max) ;
    ...
    public Set<Tuple> zrevrangeByScoreWithScores(final String key,final String namespace, final double max, final double min) ;
    ...
    public Set<Tuple> zrangeByScoreWithScores(final String key,final String namespace, final double min, final double max, final int offset,
            final int count) ;
    ...
    public Long linsert(final String key,final String namespace, final LIST_POSITION where, final String pivot, final String value) ;
    ...
    public Long del(final String key,final String namespace) ;
    ...
    public Long lpush(final String key,final String namespace, final String... fields) ;
    ...
    public Long rpush(final String key,final String namespace, final String... fields) ;
    ...
    public Boolean setbit(final String key,final String namespace, final long offset, final String value) ;
    ...
    public Long strlen(final String key,final String namespace);
     ...
     * @return 比特位的数量
     */
    public Long bitcount(final String key,final String namespace);
     ...
     * @return 比特位的数量
     */
    public Long bitcount(final String key,final String namespace, final long start, final long end) ;
     ...
     * @param time seconds
     */
    public <T> String set(final String key,final String namespace, final T value,final int time);
     ...
     * @return json字符串
     */
    public <T> T get(final String key,final String namespace,Class<T> value);    
     ...
     * @return json字符串
     */
    public <T> Long hsetObject(final String key,final String namespace,final String field, final T value);
     ...
     * @return <T> 泛型对象
     */
    public <T> T hgetObject(final String key,final String namespace,final String field, Class<T> value);
     ...
     * @param <T> 泛型对象
     */
    public <T> Map<String, T> hgetAllObjects(final String key,final String namespace,Class<T> value);
     ...
     * @Param cursor
     * */
    public List<Map.Entry<String, String>> hscan(final String key,final String namespace,final String match);
     ...
     * @Param cursor
     * */
    public Set<String> sscan(final String key,final String namespace, final String match);
	...
	<T> T get(String key, String namespace, TypeReference<T> type);

	<T> T hget(String key, String namespace, String field, TypeReference<T> type);

	<T> T hget(String key, String namespace, String field, Class<T> type);
